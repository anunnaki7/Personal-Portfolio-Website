    ...
    >
      ...
      >
        ...
        <div className="relative h-52 md:h-64 lg:h-72 overflow-hidden">
          ...
          {project.hasRealImage && !imageError ? (
              ...
              {!imageLoaded && (
                <div className="absolute inset-0 bg-gradient-to-br from-[#1a0a0a] to-[#0a0a0a] flex items-center justify-center">
                  <div className="flex items-center gap-2">
                    <motion.div className="w-2 h-2 bg-[#ff0040] rounded-full" animate={{ scale: [1, 1.5, 1], opacity: [1, 0.5, 1] }} transition={{ duration: 0.8, repeat: Infinity, delay: 0 }} />
                    <motion.div className="w-2 h-2 bg-[#ff0040] rounded-full" animate={{ scale: [1, 1.5, 1], opacity: [1, 0.5, 1] }} transition={{ duration: 0.8, repeat: Infinity, delay: 0.2 }} />
                    <motion.div className="w-2 h-2 bg-[#ff0040] rounded-full" animate={{ scale: [1, 1.5, 1], opacity: [1, 0.5, 1] }} transition={{ duration: 0.8, repeat: Infinity, delay: 0.4 }} />
                  </div>
                </div>
              )}
              <motion.img
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-[#150505] to-[#0a0505]">
              <motion.div
                ...
                animate={{ scale: isHovered ? 1.15 : 1, rotateY: isHovered ? 15 : 0 }}
              ...
              <motion.div className="absolute w-32 h-32 border border-[#ff0040]/20 rounded-full" animate={{ scale: [1, 1.5, 1], opacity: [0.3, 0, 0.3] }} transition={{ duration: 3, repeat: Infinity }} />
              <motion.div className="absolute w-48 h-48 border border-[#ff0040]/10 rounded-full" animate={{ scale: [1, 1.3, 1], opacity: [0.2, 0, 0.2] }} transition={{ duration: 3, repeat: Infinity, delay: 0.5 }} />
            </div>
          )}
          ...
          >
            ...
            >
              <motion.a
                ...
                className="group/btn relative px-6 py-3 font-bold text-sm rounded-lg overflow-hidden border-2 border-[#ff0040] text-[#ff0040] hover:text-white transition-colors duration-300"
                whileHover={{ scale: 1.05, boxShadow: '0 0 30px rgba(255,0,64,0.5)' }}
                whileTap={{ scale: 0.95 }}
                onClick={(e: React.MouseEvent) => e.stopPropagation()}
              >
                <motion.div className="absolute inset-0 bg-[#ff0040]" initial={{ x: '-100%' }} whileHover={{ x: 0 }} transition={{ duration: 0.3 }} />
              ...
              {project.githubUrl !== '#' && (
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group/btn relative px-6 py-3 font-bold text-sm rounded-lg bg-black/50 border border-[#ff0040]/50 text-gray-300 hover:text-white hover:border-[#ff0040] transition-all duration-300"
          ...
          {project.featured && (
            <motion.div className="absolute top-4 right-4 z-30" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }}>
              <motion.div
          ...
          <motion.div className="absolute top-4 left-4 z-30" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }}>
        ...
        <div className="p-5 md:p-6 relative">
          <motion.div
            ...
            style={{ background: 'linear-gradient(90deg, transparent, rgba(255,0,64,0.5), transparent)' }}
          ...
          {project.featured && (
            <motion.a
              ...
              style={{ background: 'linear-gradient(135deg, rgba(255,0,64,0.2) 0%, rgba(255,0,64,0.1) 100%)' }}
              whileHover={{ scale: 1.02, boxShadow: '0 0 40px rgba(255,0,64,0.4), inset 0 0 20px rgba(255,0,64,0.1)' }}
              whileTap={{ scale: 0.98 }}
            >
              <motion.div
    ...
    <section id="projects" className="py-20 md:py-28 relative z-10">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          ...
          style={{ background: 'radial-gradient(circle, rgba(255,0,64,0.08) 0%, transparent 70%)' }}
        />
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6" ref={ref}>
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          >
            <motion.span
              className="px-4 py-1.5 font-mono text-sm tracking-widest rounded"
              style={{
                fontFamily: "'Orbitron', sans-serif",
                color: '#ff0040',
                border: '1px solid rgba(255,0,64,0.5)',
                background: 'rgba(255,0,64,0.05)',
                textShadow: '0 0 10px rgba(255,0,64,0.8), 0 0 20px rgba(255,0,64,0.5), 0 0 40px rgba(255,0,64,0.3)',
                boxShadow: '0 0 15px rgba(255,0,64,0.2), inset 0 0 15px rgba(255,0,64,0.05)',
              }}
              animate={{
                textShadow: [
                  '0 0 10px rgba(255,0,64,0.8), 0 0 20px rgba(255,0,64,0.5), 0 0 40px rgba(255,0,64,0.3)',
                  '0 0 15px rgba(255,0,64,1), 0 0 30px rgba(255,0,64,0.8), 0 0 60px rgba(255,0,64,0.5)',
                  '0 0 10px rgba(255,0,64,0.8), 0 0 20px rgba(255,0,64,0.5), 0 0 40px rgba(255,0,64,0.3)',
                ],
                boxShadow: [
                  '0 0 15px rgba(255,0,64,0.2), inset 0 0 15px rgba(255,0,64,0.05)',
                  '0 0 25px rgba(255,0,64,0.4), inset 0 0 20px rgba(255,0,64,0.1)',
                  '0 0 15px rgba(255,0,64,0.2), inset 0 0 15px rgba(255,0,64,0.05)',
                ],
              }}
        ...
        >
          <motion.a
            ...
            style={{ background: 'linear-gradient(135deg, rgba(255,0,64,0.05) 0%, transparent 100%)' }}
